...
func (c *executorServiceClient) ProcessBatchV2(ctx context.Context, in *ProcessBatchRequestV2, opts ...grpc.CallOption) (*ProcessBatchResponseV2, error) {
	...
	err := c.cc.Invoke(ctx, "/executor.v1.ExecutorService/ProcessBatchV2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorServiceClient) ProcessBatchV3(ctx context.Context, in *ProcessBatchRequestV3, opts ...grpc.CallOption) (*ProcessBatchResponseV3, error) {
	...
	err := c.cc.Invoke(ctx, "/executor.v1.ExecutorService/ProcessBatchV3", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorServiceClient) ProcessBlobInnerV3(ctx context.Context, in *ProcessBlobInnerRequestV3, opts ...grpc.CallOption) (*ProcessBlobInnerResponseV3, error) {
	...
	err := c.cc.Invoke(ctx, "/executor.v1.ExecutorService/ProcessBlobInnerV3", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorServiceClient) ProcessStatelessBatchV2(ctx context.Context, in *ProcessStatelessBatchRequestV2, opts ...grpc.CallOption) (*ProcessBatchResponseV2, error) {
	out := new(ProcessBatchResponseV2)
	err := c.cc.Invoke(ctx, "/executor.v1.ExecutorService/ProcessStatelessBatchV2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExecutorService_ProcessBatchV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/executor.v1.ExecutorService/ProcessBatchV2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutorService_ProcessBatchV3_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/executor.v1.ExecutorService/ProcessBatchV3",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutorService_ProcessBlobInnerV3_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/executor.v1.ExecutorService/ProcessBlobInnerV3",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutorService_ProcessStatelessBatchV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/executor.v1.ExecutorService/ProcessStatelessBatchV2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
